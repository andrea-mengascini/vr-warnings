...
#calculate median
agg_med<-aggregate(diff ~ warning, data=test, median)

#calculate interquartile range
agg_iqr<-aggregate(diff ~ warning, data=test, IQR)

#find the minimum of each condition
agg_min<-aggregate(diff ~ warning, data=test, min)

#find the maximum of each condition
agg_max<-aggregate(diff ~ warning, data=test, max)
